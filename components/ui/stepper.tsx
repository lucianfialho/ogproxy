...
export default function Stepper({
  ...
  return (
    <div className="flex min-h-full flex-1 flex-col items-center justify-center" {...rest}>
      <div className={`mx-auto w-full max-w-3xl ${stepCircleContainerClassName}`}>
        <div className={`${stepContainerClassName} flex w-full items-center mb-12`}>
...
function StepIndicator({ step, currentStep, onClickStep, disableStepIndicators = false }: StepIndicatorProps) {
  ...
  return (
    ...
    >
      <motion.div
        variants={{
          inactive: { scale: 1, backgroundColor: '#1f2937', color: '#6b7280' },
...
function StepConnector({ isComplete }: StepConnectorProps) {
  ...
  return (
    <div className="relative mx-2 h-0.5 flex-1 overflow-hidden rounded bg-gray-800">
      <motion.div
